...
import com.nokhaiz.indicatorView.animation.type.ScaleAnimation
...
import com.nokhaiz.indicatorView.draw.data.PositionSavedState
import com.nokhaiz.indicatorView.draw.data.RtlMode
import com.nokhaiz.indicatorView.utils.CoordinatesUtils.getProgress
import com.nokhaiz.indicatorView.utils.DensityUtils.dpToPx
import com.nokhaiz.indicatorView.utils.IdUtils
    ...
    private val isRtl: Boolean
        private get() {
            return when (manager!!.indicator().rtlMode) {
                On -> true
                Off -> false
                Auto -> TextUtilsCompat.getLayoutDirectionFromLocale(context.resources.configuration.locale) == ViewCompat.LAYOUT_DIRECTION_RTL
                null -> false
            }
        }
